        ...
        <div data-aos="fade-up" className="relative mt-10 ">
              <div className="backdrop-blur border border-gray-400 rounded-xl bg-white/10 p-5">
                ...
                <div className="mt-20 text-center text-white">
                    <p className="flex justify-center font-josefin text-2xl items-center gap-2">{name}<BsFillPatchCheckFill className="text-lg text-blue-400"/></p>
                ...
                <div className="flex justify-around items-center">
                    ...
                    {worker_details?.map(work =>
                         <div>
                            <p className="flex mt-1 gap-2 items-center text-gray-200  font-josefin font-light"><BsCheckAll className=" text-lg text-green-500"/>{work}</p>
                         </div>
                         )}
