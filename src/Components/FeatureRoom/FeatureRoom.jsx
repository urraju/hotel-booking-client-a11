...
const FeatureRoom = () => {
    ...
    return(
        <div className="mt-20 px-5">
            <div className="text-center mb-14 font-josefin">
                <h1 className="first-letter:text-5xl first-letter:text-rose-500 mb-2 text-4xl">Feature Room Comming Soon!</h1>
                <p className="text-gray-500">Lorem ipsum dolor, sit amet consectetur adipisicing elit.   Libero molestiae labore, <br /> odio explicabo voluptas omnis.</p>
            </div>
